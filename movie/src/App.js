...
const App = () => {
  const [movies, setMovies] = useState([
    ...
    },
    {
      ...
      posterURL: "https://m.media-amazon.com/images/M/MV5BMjI3MDI0MTA1N15BMl5BanBnXkFtZTgwOTk4NjU5ODE@._V1_.jpg",
      rating: "4",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      posterURL: "https://m.media-amazon.com/images/M/MV5BMTY0NDY3MDMxN15BMl5BanBnXkFtZTcwOTM5NzMzOQ@@._V1_.jpg" ,
      rating: "4",
    },
    {
      id: 8,
  ...
  return (
    <div>
      ...
      <MovieList movies={movies} ratingChanged={ratingChanged} />
      {/*<h1>{movie.title}</h1>
